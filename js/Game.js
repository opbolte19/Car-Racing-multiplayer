class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 160, y: height - 1500, image: obstacle2Image },
      { x: width / 2 + 280, y: height - 1900, image: obstacle2Image },
      { x: width / 2 - 280, y: height - 3500, image: obstacle2Image },
     
      { x: width / 2 - 180, y: height - 4450, image: obstacle2Image },
